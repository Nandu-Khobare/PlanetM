...
{
    public partial class RecentMovieViewer : Form
    {
        DBOperations dbObj = new DBOperations();
        public RecentMovieViewer()
        {
            InitializeComponent();
            LoadMovies();
        }
        ...
        {
            DataTable movies = dbObj.GetRecentMovies().Tables[0];
            this.Text = "Recent Movies :: Count : " + movies.Rows.Count.ToString();
            dgMovies.Rows.Clear();
            int iterator = 0;
        ...
        private void RecentMovieViewer_KeyDown(object sender, KeyEventArgs e)
        {
